...
namespace Nop.Web.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual async Task<string> PrepareRobotsTextFileAsync()
        {
            ...
            var robotsFilePath = _fileProvider.Combine(_fileProvider.MapPath("~/"), RobotsTxtDefaults.RobotsCustomFileName);
            ...
            else
            {
                ...
                var robotsAdditionsFile = _fileProvider.Combine(_fileProvider.MapPath("~/"), RobotsTxtDefaults.RobotsAdditionsFileName);
